...
<head>
    ...
    <title>404 - Portal Ciudadano de Denuncias</title>
...
<body>
    <div class="error-card">
        <i class="bi bi-search" style="font-size: 4rem; color: #93c5fd;"></i>
        <h1 class="mt-3 fw-bold">404</h1>
        <p class="opacity-75">Página no encontrada. El recurso que buscas no existe.</p>
