<?php
/**
 * Portal Ciudadano de Denuncias - Mis Investigaciones
 */
$pageTitle = 'Mis Casos';
...
<div class="main-content">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted">Cuando se te asigne una denuncia ciudadana, aparecerá aquí.</p>
        </div>
    </div>
    <?php else: ?>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <small class="text-muted d-block">Ingresada: <?= formatDateTime($c['created_at']) ?></small>
