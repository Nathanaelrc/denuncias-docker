...
// Ruta base del portal según APP_URL (ej. http://host:9090/generales → /generales)
$_appUrl = rtrim((string)(getenv('APP_URL') ?: '/generales'), '/');
$_appBase = parse_url($_appUrl, PHP_URL_PATH) ?: '/generales';
