<?php
/**
 * Portal Denuncias Ciudadanas EPCO - Barra Superior de Navegación entre Portales
...
$_otherPortalUrl = getenv('APP_URL_KARIN') ?: 'http://localhost:8091';
?>
<style>
...
.navbar.fixed-top,.navbar-epco.fixed-top{top:36px !important}
</style>
<div class="barra-portales">
    <div class="d-flex align-items-center">
        ...
        <a href="<?= htmlspecialchars($_otherPortalUrl) ?>">
            <i class="bi bi-shield-check me-1"></i>Ley Karin
        </a>
        <span class="bp-sep">|</span>
        <span class="bp-actual"><i class="bi bi-globe2 me-1"></i>Portal Ciudadano</span>
    </div>
